            ...
            <div class="row">
                ...
                <div class="col-12 col-lg-4">
                    <div class="course-sidebar">
                        ...
                        $sql = "Select course_name from courses_ where u_email=? and course_name = 'cplusplus';";
                        ...
                        if($resultCheck > 0 ){
                            echo '<input type = "submit" class="btn clever-btn mb-30 w-100" name="cplusplus" value= "Enrolled">';

                        }
                        else {
                            echo '<form action="php/enroll.inc.php" method="POST">
                                <input type = "submit" class="btn clever-btn mb-30 w-100" name="cplusplus" value= "Enroll">
                                </form>';
                        }
                    }
                        ?>
